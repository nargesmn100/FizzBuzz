...
Feel free to take notes in it as you go or just read the preview view of it. Neat!
...
the file. Then click the commit button to commit the change to the repository. (Small edit made!)
